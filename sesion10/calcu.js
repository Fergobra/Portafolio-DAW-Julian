...
let abcdef = prompt("Qué quieres hacer 1 sumar / 2 restar / 3 multiplicar / 4 dividir?");
switch(abcdef) {
    case '1':
      sumar();
      break;
...
let b = prompt("introduce otro numero entero");
    ...
    var sino = prompt("Quieres dividir otro numero si/no?");
        while(sino == "si"){
            ...
            console.log("El número guardado dividido entre el nuevo numero ingresado da " + y);
            f = y;
            y = 0;
